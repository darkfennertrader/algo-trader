...
_AUXILIARY_DEFAULTS = {
    ...
    "df": 8.0,
    "obs_weight": 0.05,
    "curated_pair_obs_weight": 0.12,
    "residual_obs_weight": 0.02,
    "mad_floor": 1e-4,
    "eps": 1e-6,
}

guide_default_params_v17_l1 = guide_default_params_dependence_followup
model_default_params_v17_l1 = make_dependence_followup_model_defaults(
    param_key="curated_pair_index_relative",
    overrides=_AUXILIARY_DEFAULTS,
)

__all__ = [
    "guide_default_params_v17_l1",
    "model_default_params_v17_l1",
]
