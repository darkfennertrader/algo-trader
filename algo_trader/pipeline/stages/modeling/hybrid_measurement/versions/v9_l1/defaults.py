...
def guide_default_params_v9_l1() -> dict[str, Any]:
    return {
        **build_guide_defaults(_FACTOR_COUNT_DEFAULTS_V9_L1),
        "index_group_enabled": False,
        "hybrid_measurement_enabled": True,
    }


def model_default_params_v9_l1() -> dict[str, Any]:
    return {
        "mean": {
            "alpha_scale": 0.03,
            "sigma_fx_scale": 0.03,
        ...
        "hybrid_measurement": {
            ...
            "prior_scales": {
                "state_scale": 0.10,
                "loading_deviation": 0.08,
                "composite_loading_deviation": 0.025,
                "primitive_residual_scale": 0.85,
                "composite_residual_scale": 0.30,
                "residual_log_scale": 0.20,
                "composite_residual_log_scale": 0.08,
                "correlation_concentration": 15.0,
            },
            "eps": 1e-6,
        },
    }
...
__all__ = [
    "guide_default_params_v9_l1",
    "merge_nested_params",
    "model_default_params_v9_l1",
]
