...
def guide_default_params_v9_l2() -> dict[str, Any]:
    return {
        **build_guide_defaults(_FACTOR_COUNT_DEFAULTS_V9_L2),
        "index_group_enabled": False,
        "hybrid_measurement_enabled": True,
    }


def model_default_params_v9_l2() -> dict[str, Any]:
    return {
        "mean": {
            "alpha_scale": 0.03,
            "sigma_fx_scale": 0.03,
        ...
        "hybrid_measurement": {
            ...
            "prior_scales": {
                "state_scale": 0.06,
                "loading_deviation": 0.05,
                "composite_loading_deviation": 0.01,
                "primitive_residual_scale": 0.90,
                "composite_residual_scale": 0.40,
                "residual_log_scale": 0.18,
                "composite_residual_log_scale": 0.06,
                "correlation_concentration": 25.0,
            },
            "eps": 1e-6,
        },
    }
...
__all__ = [
    "guide_default_params_v9_l2",
    "merge_nested_params",
    "model_default_params_v9_l2",
]
