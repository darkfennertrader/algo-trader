...
def guide_default_params_v11_l1() -> dict[str, Any]:
    return {
        **build_guide_defaults(_FACTOR_COUNT_DEFAULTS_V11_L1),
        "index_group_enabled": False,
        "index_t_copula_enabled": True,
        "index_subspace_consistency_enabled": True,
    }


def model_default_params_v11_l1() -> dict[str, Any]:
    return {
        "mean": {
            "alpha_scale": 0.03,
            "sigma_fx_scale": 0.03,
        ...
        "index_subspace_consistency": {
            ...
            "obs_weight": 0.35,
            "prior_scales": {
                "global_scale_center": 0.95,
                "global_scale_log_scale": 0.10,
                "spread_scale_center": 0.45,
                "spread_scale_log_scale": 0.18,
                "correlation_concentration": 18.0,
            },
            "eps": 1e-6,
        },
    }
...
__all__ = [
    "guide_default_params_v11_l1",
    "merge_nested_params",
    "model_default_params_v11_l1",
]
