...
def guide_default_params_v11_l2() -> dict[str, Any]:
    return {
        **build_guide_defaults(_FACTOR_COUNT_DEFAULTS_V11_L2),
...
def model_default_params_v11_l2() -> dict[str, Any]:
    return {
        "mean": {
            "alpha_scale": 0.03,
            "sigma_fx_scale": 0.03,
        ...
        "index_subspace_consistency": {
            ...
            "obs_weight": 0.18,
            "prior_scales": {
                "spread_scale_center": 0.30,
                "spread_scale_log_scale": 0.12,
...
__all__ = [
    "guide_default_params_v11_l2",
    "merge_nested_params",
    "model_default_params_v11_l2",
]
