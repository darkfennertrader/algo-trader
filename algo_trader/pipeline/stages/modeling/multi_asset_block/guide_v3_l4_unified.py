...
from .v3_l4_defaults import guide_default_params_v3_l4, merge_nested_params


@register_guide("multi_asset_block_guide_v3_l4_unified_online_filtering")
def build_multi_asset_block_guide_v3_l4_unified_online_filtering(
    params: Mapping[str, Any]
) -> PyroGuide:
    merged_params = merge_nested_params(guide_default_params_v3_l4(), params)
