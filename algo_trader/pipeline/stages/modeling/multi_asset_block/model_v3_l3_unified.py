...
from .v3_l3_defaults import merge_nested_params, model_default_params_v3_l3


@register_model("multi_asset_block_model_v3_l3_unified_online_filtering")
def build_multi_asset_block_model_v3_l3_unified_online_filtering(
    params: Mapping[str, Any]
) -> PyroModel:
    merged_params = merge_nested_params(model_default_params_v3_l3(), params)
