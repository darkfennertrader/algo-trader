...
from .v3_l4_defaults import merge_nested_params, model_default_params_v3_l4


@register_model("multi_asset_block_model_v3_l4_unified_online_filtering")
def build_multi_asset_block_model_v3_l4_unified_online_filtering(
    params: Mapping[str, Any]
) -> PyroModel:
    merged_params = merge_nested_params(model_default_params_v3_l4(), params)
