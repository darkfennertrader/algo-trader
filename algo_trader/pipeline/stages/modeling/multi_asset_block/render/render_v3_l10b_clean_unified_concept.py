...
def main() -> None:
    ...
    graph = graphviz.Digraph("concept_v3_l10b_clean_unified", format="png")
    ...
    graph.node("goal", "reduce US-side over-width\nwithout giving back Europe gains")
    ...
    output_path = output_dir / "concept_v3_l10b_clean_unified.png"
