...
def guide_default_params_v3_l3() -> dict[str, Any]:
    return build_guide_defaults(_FACTOR_COUNT_DEFAULTS_V3_L3)


def model_default_params_v3_l3() -> dict[str, Any]:
    return {
        "mean": {
            "alpha_scale": 0.03,
            "sigma_fx_scale": 0.03,
        ...
        "regime": {
            ...
            "index": {"phi": 0.97, "s_u_scale": 0.015},
...
__all__ = [
    "guide_default_params_v3_l3",
    "merge_nested_params",
    "model_default_params_v3_l3",
]
