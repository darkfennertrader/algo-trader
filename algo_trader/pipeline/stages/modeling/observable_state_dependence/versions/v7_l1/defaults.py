...
def guide_default_params_v7_l1() -> dict[str, Any]:
    return {
        **build_guide_defaults(_FACTOR_COUNT_DEFAULTS_V7_L1),
        "observable_state_dependence_enabled": True,
    }


def model_default_params_v7_l1() -> dict[str, Any]:
    return {
        "mean": {
            "alpha_scale": 0.03,
            "sigma_fx_scale": 0.03,
...
__all__ = [
    "guide_default_params_v7_l1",
    "merge_nested_params",
    "model_default_params_v7_l1",
]
