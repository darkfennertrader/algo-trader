...
def guide_default_params_v10_l2() -> dict[str, Any]:
    return {
        **build_guide_defaults(_FACTOR_COUNT_DEFAULTS_V10_L2),
        "index_group_enabled": False,
        "state_conditioned_measurement_enabled": True,
    }


def model_default_params_v10_l2() -> dict[str, Any]:
    return {
        "mean": {
            "alpha_scale": 0.03,
            "sigma_fx_scale": 0.03,
        ...
        "state_conditioned_measurement": {
            ...
            "condition_prior_scales": {
                ...
                "global_weight": 0.35,
                "index_weight": 0.35,
                "contrast_strength": 0.02,
                "composite_residual_strength": 0.05,
            },
            "eps": 1e-6,
        },
    }
...
__all__ = [
    "guide_default_params_v10_l2",
    "merge_nested_params",
    "model_default_params_v10_l2",
]
