...
def test_v15_l1_prediction_supports_explicit_predictor_config() -> None:
    config = _v15_l1_online_filtering_config(
        predict_name="multi_output_index_relative_predict_v15_l1_online_filtering"
    )
...
def _v15_l1_online_filtering_config(
    *, predict_name: str | None = None
) -> dict[str, Any]:
    return {
        "model": {
            "model_name": "multi_output_index_relative_model_v15_l1_online_filtering",
            "guide_name": "multi_output_index_relative_guide_v15_l1_online_filtering",
