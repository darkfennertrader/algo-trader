...
def test_v16_l1_prediction_supports_explicit_predictor_config() -> None:
    config = _v16_l1_online_filtering_config(
        predict_name="pairwise_index_relative_predict_v16_l1_online_filtering"
    )
...
def _v16_l1_online_filtering_config(
    *, predict_name: str | None = None
) -> dict[str, Any]:
    return {
        "model": {
            "model_name": "pairwise_index_relative_model_v16_l1_online_filtering",
            "guide_name": "pairwise_index_relative_guide_v16_l1_online_filtering",
