...
def test_v18_l1_prediction_supports_explicit_predictor_config() -> None:
    config = _v18_l1_online_filtering_config(
        predict_name="pair_state_conditioned_curated_pair_predict_v18_l1_online_filtering"
    )
...
def _v18_l1_online_filtering_config(
    *, predict_name: str | None = None
) -> dict[str, Any]:
    return {
        "model": {
            "model_name": "pair_state_conditioned_curated_pair_model_v18_l1_online_filtering",
            "guide_name": "pair_state_conditioned_curated_pair_guide_v18_l1_online_filtering",
