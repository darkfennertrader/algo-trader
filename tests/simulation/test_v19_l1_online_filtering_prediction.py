...
def test_v19_l1_prediction_supports_explicit_predictor_config() -> None:
    config = _v19_l1_online_filtering_config(
        predict_name="hierarchical_index_experts_predict_v19_l1_online_filtering"
    )
...
def _v19_l1_online_filtering_config(
    *, predict_name: str | None = None
) -> dict[str, Any]:
    return {
        "model": {
            "model_name": "hierarchical_index_experts_model_v19_l1_online_filtering",
            "guide_name": "hierarchical_index_experts_guide_v19_l1_online_filtering",
