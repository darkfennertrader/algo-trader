...
def test_v3_l10b_clean_unified_prediction_supports_explicit_predictor_config() -> None:
    config = _v3_l10b_clean_unified_online_filtering_config(
        predict_name=(
...
def test_v3_l10b_clean_unified_rejects_tbptt_training_method() -> None:
    config = _v3_l10b_clean_unified_online_filtering_config()
...
def _v3_l10b_clean_unified_online_filtering_config(
    *, predict_name: str | None = None
) -> dict[str, Any]:
    return {
        "model": {
            "model_name": "multi_asset_block_model_v3_l10b_clean_unified_online_filtering",
            "guide_name": "multi_asset_block_guide_v3_l10b_clean_unified_online_filtering",
