...
def test_v8_l1_runtime_registry_builds_model_and_guide() -> None:
    model = modeling.default_model_registry().get(
        "index_basis_model_v8_l1_online_filtering"
    )
    guide = modeling.default_guide_registry().get(
        "index_basis_guide_v8_l1_online_filtering"
    )
...
def test_v8_l1_runtime_guide_accepts_prediction_batch() -> None:
    guide = modeling.default_guide_registry().get(
        "index_basis_guide_v8_l1_online_filtering"
    )
...
def test_v9_l1_runtime_registry_builds_model_and_guide() -> None:
    model = modeling.default_model_registry().get(
        "hybrid_measurement_model_v9_l1_online_filtering"
    )
    guide = modeling.default_guide_registry().get(
        "hybrid_measurement_guide_v9_l1_online_filtering"
    )
    train_batch = _runtime_batch_index_basis(with_targets=True)
...
def test_v9_l1_runtime_guide_accepts_prediction_batch() -> None:
    guide = modeling.default_guide_registry().get(
        "hybrid_measurement_guide_v9_l1_online_filtering"
    )
    predict_batch = _runtime_batch_index_basis(with_targets=False)
...
def test_v9_l2_runtime_registry_builds_model_and_guide() -> None:
    model = modeling.default_model_registry().get(
        "hybrid_measurement_model_v9_l2_online_filtering"
    )
    guide = modeling.default_guide_registry().get(
        "hybrid_measurement_guide_v9_l2_online_filtering"
    )
    train_batch = _runtime_batch_index_basis(with_targets=True)
...
def test_v9_l2_runtime_guide_accepts_prediction_batch() -> None:
    guide = modeling.default_guide_registry().get(
        "hybrid_measurement_guide_v9_l2_online_filtering"
    )
    predict_batch = _runtime_batch_index_basis(with_targets=False)
...
def test_v10_l1_runtime_registry_builds_model_and_guide() -> None:
    model = modeling.default_model_registry().get(
        "state_conditioned_measurement_model_v10_l1_online_filtering"
    )
    guide = modeling.default_guide_registry().get(
        "state_conditioned_measurement_guide_v10_l1_online_filtering"
    )
    train_batch = _runtime_batch_index_basis(with_targets=True)
...
def test_v10_l1_runtime_guide_accepts_prediction_batch() -> None:
    guide = modeling.default_guide_registry().get(
        "state_conditioned_measurement_guide_v10_l1_online_filtering"
    )
    predict_batch = _runtime_batch_index_basis(with_targets=False)
...
def test_v10_l2_runtime_registry_builds_model_and_guide() -> None:
    model = modeling.default_model_registry().get(
        "state_conditioned_measurement_model_v10_l2_online_filtering"
    )
    guide = modeling.default_guide_registry().get(
        "state_conditioned_measurement_guide_v10_l2_online_filtering"
    )
    train_batch = _runtime_batch_index_basis(with_targets=True)
...
def test_v10_l2_runtime_guide_accepts_prediction_batch() -> None:
    guide = modeling.default_guide_registry().get(
        "state_conditioned_measurement_guide_v10_l2_online_filtering"
    )
    predict_batch = _runtime_batch_index_basis(with_targets=False)
