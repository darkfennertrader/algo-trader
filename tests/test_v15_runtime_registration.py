...
def test_v15_l1_runtime_registry_builds_model_and_guide() -> None:
    model = modeling.default_model_registry().get(
        "multi_output_index_relative_model_v15_l1_online_filtering"
    )
    guide = modeling.default_guide_registry().get(
        "multi_output_index_relative_guide_v15_l1_online_filtering"
    )
...
def test_v15_l1_runtime_guide_accepts_prediction_batch() -> None:
    guide = modeling.default_guide_registry().get(
        "multi_output_index_relative_guide_v15_l1_online_filtering"
    )
